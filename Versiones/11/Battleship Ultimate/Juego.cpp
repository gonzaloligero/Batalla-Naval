   ...
   cin.ignore();
       ...
       // setColor(LIGHTRED);
        ...
        while(ganador == false){
                ...
                tablero2.atacarModoClasico(fila,columna, tablero2,aux1);
                ...
                tablero1.atacarModoClasico(fila,columna,tablero1,aux2);
...
//CREACION DE GAMEOVER
sf::Sprite gameOver;
sf::Texture texturaGameOver;
gameOver.setPosition(400,300);
texturaGameOver.loadFromFile("C:/Users/Gonzalo/Desktop/Database/Sprites/Pantallas/GameOver.png");
gameOver.setTexture(texturaGameOver);

//CREACION DE WINNER
sf::Sprite winner;
sf::Texture texturaWinner;
winner.setPosition(400,300);
texturaWinner.loadFromFile("C:/Users/Gonzalo/Desktop/Database/Sprites/Pantallas/Winner.png");
gameOver.setTexture(texturaWinner);
