...
while(acorazadoUbicado == false){
    ...
    if(direccion == 1){
        if(_Tamanio[fila-1][columna-1] == 1 || _Tamanio[fila][columna-1] == 1 || _Tamanio[fila][columna-2] == 1){
            cout<<"Se detecto una embarcacion en ese lugar. Elija otro"<<endl;
            }else{
    ...
    if(direccion == 2){
        if(_Tamanio[fila-1][columna-1] == 1 || _Tamanio[fila-1][columna] == 1 || _Tamanio[fila][columna-2] == 1){
            cout<<"Se detecto una embarcacion en ese lugar. Elija otro"<<endl;
            }else{
                _Tamanio[fila-1][columna-1] = 1;
...
int fila = 5,columna = 5, x, y, direccion;
...
while(portaavionesUbicado == false){
    ...
    if(direccion == 1){
        if(_Tamanio[fila-1][columna-1] == 1 || _Tamanio[fila][columna] == 1 || _Tamanio[fila][columna-1] == 1 || _Tamanio[fila][columna-2] == 1){
            cout<<"Se detecto una embarcacion en ese lugar. Elija otro"<<endl;
            }else{
                _Tamanio[fila-1][columna-1] = 1;
                _Tamanio[fila][columna-1] = 1;
    ...
    if(direccion == 2){
        if(_Tamanio[fila-1][columna-1] == 1 || _Tamanio[fila-1][columna] == 1 || _Tamanio[fila][columna-2] == 1 || _Tamanio [fila][columna-3] == 1){
            cout<<"Se detecto una embarcacion en ese lugar. Elija otro"<<endl;
            }else{
                _Tamanio[fila-1][columna-1] = 1;
                _Tamanio[fila-1][columna] = 1;
